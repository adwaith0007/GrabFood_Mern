                   ...
                   <tr>
                     ...
                     <td class="pl-4">
                       <div>
                         ...
                         <p class="whitespace-nowrap font-bold text-main text-right">233 454 546</p>
                       </div>
                     </td>
                   </tr>
                 </tbody>
         ...
         <tr>
           <td class="w-1/2 align-top">
             <div class="text-sm text-neutral-600">
               <p class="font-bold">Grabfood Company INC</p>
               <p>Name: Grabfood</p>
               <p>Phone: ${phone}</p>
               <!-- Assuming address is an object -->
               <p>Address: 1234 Imaginary Lane</p>
               <p>Fictionville, FA 56789</p>
               <p>USA</p>
