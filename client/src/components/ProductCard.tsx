...
ProductCardProps) => {
  ...
  const handleToggleFavorite = async () => {
    try {
      ...
      const response = await api.post("/user/wishlist/toggle_add", {
        userId,
        productId,
      });
    ...
    <div className="relative m-10 flex w-full max-w-xs  flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
      ...
      >
        ...
        <FontAwesomeIcon
          icon={faHeart}
          color={
            userFavourites.some((item) => item.productId === productId)
              ? "red"
              : "white"
          }
        />
...
//   const handleToggleFavorite = async () => {
//     try {
//       const response = await api.post('/user/wishlist/toggle_add', { userId, productId });
//       if (response.data.success) {
//         fetchingFavourites();
//       }
//     } catch (error) {
...
//   return (
//     <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
//       <Link className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" to={`/product/${productId}`}>
//         {loading ? (
//           <Skeleton width={70} className="h-full w-full" />
//         ) : (
...
//           <p>
//             <span className="text-3xl font-bold text-slate-900">
//               ₹{loading ? <Skeleton width={50} /> : discountPrice || price}
//             </span>
